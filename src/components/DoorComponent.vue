<template>
  <div class="door-area">
    <div class="door-frame" :class="{ selected: selected && !open }"> <!-- só vai selecionar a porta se ela n estiver aberta -->
...
export default {
    ...
    data: function() {
        //no momento inicial a porta não está aberta nem selecionada
        return {
            open: false,
            selected: false,
        }
